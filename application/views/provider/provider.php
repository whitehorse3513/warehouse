...
<div class="portlet box">
	<div class="portlet-body">
		...
		<?php if($authority["add"]) { ?>
			<a href="javascript:add_provider_modal()" class="btn btn-primary pull-right"><i class="fa fa-plus"></i> <?php echo $this->lang->line("provider") ?></a>
		<?php } ?>
			...
			<table class="table table-striped table-hover table-bordered">
				...
				<?php $i = ($page-1) * $per_page; foreach($provider as $v) {$i++;
					...
					<tr id="tr_<?php echo $v['pid']; ?>">
		                ...
		                <?php if($authority["modify"]) { ?>
						<td><a href="javascript:edit_provider_modal(<?php echo $v['pid']; ?>)"><i class="fa fa-edit"></i> <?php echo $this->lang->line("edit") ?></a></td>
                        <?php }?>
                        <?php if($authority["delete"]) { ?>
						<td><a href="javascript:confirm_delete(<?php echo $v['pid']; ?>)"><i class="fa fa-trash-o"></i> <?php echo $this->lang->line("delete") ?></a></td>
                        <?php } ?>
					</tr>
				<?php }?>
				</tbody>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-footer">
					<a href="" class="btn btn-primary" id="provider_ctrl"><?php echo $this->lang->line("save") ?></a>
...
<div class="modal fade" id="del_modal" role="dialog">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<div class="modal-footer">
				<a href="" class="btn btn-default" id="provider_del"><?php echo $this->lang->line("ok") ?></a>
				<button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line("cancel") ?></button>
			</div>
		</div>
	</div>
